    ...
    <div>
      ...
      <div className='reasons mt-8 mb-12 '>
        ...
        <div className='right-r '>
            ...
            <span className='text-6xl font-bold stroke-text  text-white'>US</span>
            </div>
        
        <div className='details-r mt-8'>
            <div className='space-x-2'>
                <CheckCircleOutlineIcon fontSize='large' style={{color:'orange'}}/>
                <span className='text-2xl text-white'>OVER 140+ EXPERT COACHS</span>
            </div>
            <div className='space-x-2'>
            <CheckCircleOutlineIcon fontSize='large' style={{color:'orange'}}/>
                <span className='text-2xl text-white'>TRAIN SMARTER AND FASTER THAN BEFORE</span>
            </div>
            <div className='space-x-2'>
            <CheckCircleOutlineIcon fontSize='large' style={{color:'orange'}}/>
                <span className='text-2xl text-white'>FREE PROGRAM FOR NEW MEMBER</span>
            </div>
            <div className='space-x-2'>
            <CheckCircleOutlineIcon fontSize='large' style={{color:'orange'}}/>
        ...
        <span className='text-3xl text-orange-300 italic   '>Our Partners : </span>
